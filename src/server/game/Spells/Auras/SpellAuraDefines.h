...
enum AuraType
{
    ...
    SPELL_AURA_MOD_SPELL_CRIT_CHANCE_SCHOOL                 = 71, // Not used in 5.4.8
    ...
    SPELL_AURA_APPLY_CREATURE_IMMUNITIES                    = 147,
    ...
    SPELL_AURA_INCREASE_SKILL_GAIN_CHANCE                   = 339,
    ...
    SPELL_AURA_MOD_AUTO_ATTACK_DAMAGE_FROM_CASTER           = 343,
    ...
    SPELL_AURA_MOD_GATHERING_ITEMS_GAINED_PERCENT           = 350,
    SPELL_AURA_351                                          = 351,
    SPELL_AURA_ENABLE_WORGER_ALTERED_FORM                   = 352,
    SPELL_AURA_MOD_CAMOUFLAGE                               = 353,  // NYI
    SPELL_AURA_MOD_HEALING_PCT_BY_TARGET_HEALTH_PCT         = 354,  // Restoration Shaman mastery - mod healing based on target's health (less = more healing)
    SPELL_AURA_355                                          = 355,
    SPELL_AURA_MOD_SPELL_DAMAGE_DONE_FROM_MANA_PERCENT      = 356,  // Arcane Mage mastery - mod damage based on current mana
    ...
    // 380 unused
    SPELL_AURA_381                                          = 381,
    SPELL_AURA_MOD_PET_STAT                                 = 382,
    SPELL_AURA_ALLOW_CAST_WHILE_IN_COOLDOWN                 = 383,
    // 384 unused
    SPELL_AURA_MISSFIRE                                     = 385,
    SPELL_AURA_386                                          = 386,
    SPELL_AURA_387                                          = 387,
    ...
    // 391 unused
    // 392 unused
    SPELL_AURA_DEFLECT_SPELLS_FRONT                         = 393,
    SPELL_AURA_BONUS_ROLL_TRIGGER                           = 394,
    SPELL_AURA_AREA_TIRGGER                                 = 395,
    SPELL_AURA_TRIGGER_ON_POWER_LEVEL                       = 396,
    SPELL_AURA_397                                          = 397,
    SPELL_AURA_MOD_SCALE_3                                  = 398,
    // 399 unused
    SPELL_AURA_400                                          = 400,
    SPELL_AURA_401                                          = 401,
    SPELL_AURA_402                                          = 402,
    SPELL_AURA_OVERRIDE_SPELL_VISUAL                        = 403,
    SPELL_AURA_OVERRIDE_ATTACK_POWER_BY_SPD                 = 404,
    SPELL_AURA_MOD_HASTE_RATING_PCT                         = 405,
    SPELL_AURA_406                                          = 406,
    SPELL_AURA_MOD_FEAR_2                                   = 407,
    SPELL_AURA_408                                          = 408,
    SPELL_AURA_TURN_WHILE_FALLING                           = 409,
    SPELL_AURA_410                                          = 410,
    SPELL_AURA_MOD_CHARGES                                  = 411,
    SPELL_AURA_MOD_MANA_REGEN_BY_HASTE                      = 412,
    SPELL_AURA_413                                          = 413,
    SPELL_AURA_FORCED_DEFLECT                               = 414,
    SPELL_AURA_415                                          = 415,
    SPELL_AURA_MOD_COOLDOWN_BY_HASTE                        = 416,
    SPELL_AURA_MOD_GLOBAL_COOLDOWN_BY_HASTE                 = 417,
    SPELL_AURA_MOD_MAX_POWER                                = 418,
    SPELL_AURA_MOD_INCREASE_ENERGY_PERCENT_2                = 419,
    SPELL_AURA_MOD_PET_XP_PCT                               = 420, // NYI
    SPELL_AURA_MOD_ABSORPTION_PCT                           = 421,
    SPELL_AURA_422                                          = 422,
    SPELL_AURA_423                                          = 423,
    SPELL_AURA_424                                          = 424,
    // 425 unused
