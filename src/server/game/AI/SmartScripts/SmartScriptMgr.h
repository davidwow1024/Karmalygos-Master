...
enum SMART_EVENT
{
    ...
    SMART_EVENT_ON_GO_REPORT_USE         = 78,      // id
...
enum SMART_ACTION
{
    ...
    SMART_ACTION_OVERRIDE_INHABIT_TYPE              = 204,
...
const uint32 SmartAIEventMask[SMART_EVENT_END][2] =
{
    ...
    { SMART_EVENT_DISTANCE_CREATURE,        SMART_SCRIPT_TYPE_MASK_CREATURE + SMART_SCRIPT_TYPE_MASK_GAMEOBJECT },
    {SMART_EVENT_DISTANCE_GAMEOBJECT,       SMART_SCRIPT_TYPE_MASK_CREATURE + SMART_SCRIPT_TYPE_MASK_GAMEOBJECT },
...
{
    SMART_EVENT_FLAG_NOT_REPEATABLE                 = 0x00001,  // Event can not repeat
    SMART_EVENT_FLAG_DIFFICULTY_DUNGEON_NORMAL      = 0x00002,
    SMART_EVENT_FLAG_DIFFICULTY_DUNGEON_HEROIC      = 0x00004,
    SMART_EVENT_FLAG_DIFFICULTY_RAID10_NORMAL       = 0x00008,
    SMART_EVENT_FLAG_DIFFICULTY_RAID25_NORMAL       = 0x00010,
    SMART_EVENT_FLAG_DIFFICULTY_RAID10_HEROIC       = 0x00020,
    SMART_EVENT_FLAG_DIFFICULTY_RAID25_HEROIC       = 0x00040,
    SMART_EVENT_FLAG_DIFFICULTY_RAID25_LFR          = 0x00080,
    SMART_EVENT_FLAG_DIFFICULTY_DUNGEON_CHALLENGE   = 0x00100,
    SMART_EVENT_FLAG_DIFFICULTY_RAID40              = 0x00200,  // not used?
    SMART_EVENT_FLAG_RESERVED_10                    = 0x00400,
    SMART_EVENT_FLAG_DIFFICULTY_SCENARIO_NORMAL     = 0x00800,
    SMART_EVENT_FLAG_DIFFICULTY_SCENARIO_HEROIC     = 0x01000,
    SMART_EVENT_FLAG_RESERVED_13                    = 0x02000,
    SMART_EVENT_FLAG_DIFFICULTY_RAID_FLEX           = 0x04000,
    SMART_EVENT_FLAG_DEBUG_ONLY                     = 0x08000,  // Event only occurs in debug build
    SMART_EVENT_FLAG_DONT_RESET                     = 0x10000,  // Event will not reset in SmartScript::OnReset()

    SMART_EVENT_FLAG_DIFFICULTY_ALL        = (SMART_EVENT_FLAG_DIFFICULTY_DUNGEON_NORMAL | SMART_EVENT_FLAG_DIFFICULTY_DUNGEON_HEROIC | SMART_EVENT_FLAG_DIFFICULTY_RAID10_NORMAL  | SMART_EVENT_FLAG_DIFFICULTY_RAID25_NORMAL  |
                                              SMART_EVENT_FLAG_DIFFICULTY_RAID10_HEROIC | SMART_EVENT_FLAG_DIFFICULTY_RAID25_HEROIC | SMART_EVENT_FLAG_DIFFICULTY_RAID25_LFR     | SMART_EVENT_FLAG_DIFFICULTY_RAID40 |
                                              SMART_EVENT_FLAG_DIFFICULTY_SCENARIO_NORMAL | SMART_EVENT_FLAG_DIFFICULTY_SCENARIO_HEROIC | SMART_EVENT_FLAG_DIFFICULTY_RAID_FLEX),
    SMART_EVENT_FLAGS_ALL                  = (SMART_EVENT_FLAG_DIFFICULTY_ALL | SMART_EVENT_FLAG_NOT_REPEATABLE | SMART_EVENT_FLAG_DEBUG_ONLY | SMART_EVENT_FLAG_DONT_RESET),
};
...
enum SmartCastFlags
{
    ...
    //SMARCAST_FORCE_CAST              = 0x04,                     // Forces cast even if creature is out of mana or out of range
    //SMARCAST_NO_MELEE_IF_OOM         = 0x08,                     // Prevents creature from entering melee if out of mana or out of range
    ...
    SMARTCAST_DEST                   = 0x80,                     // Cast in dest position
};
...
class SmartAIMgr
{
    ...
    private:
        ...
        std::unordered_map<uint32, SpellEffectPair> _creatureSpellSummonCache;
        std::unordered_map<uint32, SpellEffectPair> _gameObjectSpellSummonCache;
