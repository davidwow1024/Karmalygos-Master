...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status, processing, handler)                                      \
	...
	DEFINE_OPCODE_HANDLER(CMSG_AUCTION_LIST_PENDING_SALES,               0x02DA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAuctionListPendingSales); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_AUTH_CONTINUED_SESSION,                   0x0F49, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_AUTH_SESSION,                             0x00B2, STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_AUTOEQUIP_ITEM_SLOT,                      0x036F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAutoEquipItemSlotOpcode);
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_LEAVE,                        0x0257, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlefieldLeaveOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE,    0x1806, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBfEntryInviteResponse); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MGR_EXIT_REQUEST,             0x0343, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBfExitRequest); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE,    0x0A97, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBfQueueInviteResponse); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_BATTLEFIELD_MGR_QUEUE_REQUEST,            0x1283, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBfQueueRequest); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLEMASTER_JOIN_RATED,                  0x0674, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlemasterJoinRated); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_CONFIRM_PURCHASE_RESPONSE,     0x0812, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayConfirmPurchaseResponse); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PRODUCT_LIST,              0x0DE0, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayGetProductList); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_GET_PURCHASE_LIST,             0x18B2, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayGetPurchaseList); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PAY_START_PURCHASE,                0x1886, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePayStartPurchase); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_START_PVP_MATCHMAKING,         0x06D4, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleStartPvpMatchmaking); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_STOP_PVP_MATCHMAKING,          0x08C1, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleStopPvpMatchmaking); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_REQUEST_JOURNAL,               0x0A23, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetRequestJournal); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_REQUEST_JOURNAL_LOCK,          0x05E1, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_BATTLE_PET_UPDATE_NOTIFY,                 0x0675, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_BLACK_MARKET_BID_ON_ITEM,                 0x12C8, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBlackMarketBidOnItem); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_BLACK_MARKET_OPEN,                        0x075A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBlackMarketHelloOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_BLACK_MARKET_REQUEST_ITEMS,               0x127A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBlackMarketRequestItemOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_CAGE_BATTLE_PET,                          0x1561, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleBattlePetCage); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_CALENDAR_GUILD_FILTER,                    0x04E3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCalendarGuildFilter); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_CANCEL_MOD_SPEED_NO_CONTROL_AURAS,        0x1DE0, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleCancelModSpeedNoControlAuras); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_CHALLENGE_MODE_REQUEST_LEADERS,           0x15DB, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleChallengeModeRequestLeaders); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_CHALLENGE_MODE_REQUEST_MAP_STATS,         0x1C5A, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleChallengeModeRequestMapStats); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_CHANGE_PLAYER_DIFFICULTY,                 0x1F8E, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_CHOICE_RESPONSE,                          0x0447, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePlayerChoiceResponse); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_CLEAR_CHANNEL_WATCH,                      0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_CLEAR_RAID_MARKER,                        0x1443, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleClearRaidMarkerOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_COMPLETE_MOVIE,                           0x1362, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleCompleteMovie); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_EJECT_PASSENGER,                          0x06E7, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleEjectPassenger); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_EMOTE,                                    0x1924, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleEmoteOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_ENABLE_TAXI,                              0x0741, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleEnableTaxi); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_GET_CHALLENGE_MODE_REWARDS,               0x1452, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGetChallengeModeRewards); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_GROUP_CHANGE_SUB_GROUP,                   0x1799, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupChangeSubGroupOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_GROUP_REQUEST_JOIN_UPDATES,               0x178A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupRequestJoinUpdates); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_GUILD_ACHIEVEMENT_MEMBERS,                0x1470, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_GUILD_NEWS_UPDATE_STICKY,                 0x04D1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildNewsUpdateStickyOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_GUILD_SET_ACHIEVEMENT_TRACKING,           0x0CF0, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSetAchievementTracking); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_GUILD_SWITCH_RANK,                        0x0CD1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildSwitchRank); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_HEARTH_AND_RESURRECT,                     0x0360, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleHearthAndResurrect); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_ITEM_TEXT_QUERY,                          0x0123, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleItemTextQuery); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_JOIN_PET_BATTLE_QUEUE,                    0x06D4, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_KEEP_ALIVE,                               0x1A87, STATUS_NEVER,     PROCESS_THREADUNSAFE, &WorldSession::Handle_EarlyProccess); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_KEYBOUND_OVERRIDE,                        0x0264, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_LEARN_PET_SPECIALIZATION_GROUP,           0x1463, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLearnPetSpecialization); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_LEAVE_PET_BATTLE_QUEUE,                   0x08C1, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_LFG_LEAVE,                                0x01E0, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgLeaveOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_LFG_LOCK_INFO_REQUEST,                    0x006B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleLfgGetLockInfoOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_LFG_PROPOSAL_RESULT,                      0x1D9D, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgProposalResultOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_LFG_SET_BOOT_VOTE,                        0x17BE, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLfgSetBootVoteOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_LF_GUILD_POST_REQUEST,                    0x1450, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGuildFinderPostRequest); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_LIST_PETS,                                0x02CA, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleListPets);
	...
	DEFINE_OPCODE_HANDLER(CMSG_LOG_DISCONNECT,                           0x10B3, STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_LOG_STREAMING_ERROR,                      0x12B3, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleLogStreamingError); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_LOOT,                                     0x1CE2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_LOOT_MASTER_GIVE,                         0x1DE1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleLootMasterGiveOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_MAIL_QUERY_NEXT_TIME,                     0x077B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryNextMailTime);
	...
	DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_ADDON_GUILD,                  0x0E3B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_ADDON_INSTANCE_CHAT,          0x08AF, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_ADDON_OFFICER,                0x180B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_ADDON_PARTY,                  0x028E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_ADDON_RAID,                   0x009A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleAddonMessagechatOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_MESSAGECHAT_INSTANCE,                     0x162A, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMessagechatOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_MISSILE_TRAJECTORY_COLLISION,             0x06D6, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMissileTrajectoryCollision); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_FLIGHT_BACK_SPEED_CHANGE_ACK,  0x105B, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_FLIGHT_SPEED_CHANGE_ACK,       0x09DA, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_PITCH_RATE_CHANGE_ACK,         0x0172, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_RUN_BACK_SPEED_CHANGE_ACK,     0x0158, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_RUN_SPEED_CHANGE_ACK,          0x10F3, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_SWIM_BACK_SPEED_CHANGE_ACK,    0x10D1, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_SWIM_SPEED_CHANGE_ACK,         0x1853, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_TURN_RATE_CHANGE_ACK,          0x185A, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_FORCE_WALK_SPEED_CHANGE_ACK,         0x00DB, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleForceSpeedChangeAck); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_MOVE_SET_CAN_TURN_WHILE_FALLING_ACK,      0x0873, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMoveSetCanTurnWhileFallingAck); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_NAME_QUERY,                               0x0328, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleNameQueryOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_REALM_NAME_QUERY,                         0x1A16, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleRealmNameQueryOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_NEXT_CINEMATIC_CAMERA,                    0x1124, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleNextCinematicCamera); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_OBJECT_UPDATE_FAILED,                     0x1061, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleObjectUpdateFailedOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_OPT_OUT_OF_LOOT,                          0x06E0, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleOptOutOfLootOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_FINAL_NOTIFY,                  0x1063, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_INPUT,                         0x17BA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleInput); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_QUEUE_PROPOSE_MATCH_RESULT,    0x19C2, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_QUIT_NOTIFY,                   0x1C45, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_REQUEST_PVP,                   0x02C7, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_REQUEST_UPDATE,                0x0377, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_REQUEST_WILD,                  0x06C5, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleRequestWild); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_BATTLE_SET_FRONT_PET,                 0x1A07, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetBattleSetFrontPet); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_PET_CANCEL_AURA,                          0x12DA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePetCancelAuraOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_PING,                                     0x0012, STATUS_NEVER,     PROCESS_INPLACE,      &WorldSession::Handle_EarlyProccess); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_PLAYER_VEHICLE_ENTER,                     0x0277, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleEnterPlayerVehicle);
	...
	DEFINE_OPCODE_HANDLER(CMSG_PVP_LOG_DATA,                             0x14C2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandlePVPLogDataOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_QUERY_BATTLEFIELD_STATE,                  0x0000, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL);
	DEFINE_OPCODE_HANDLER(CMSG_QUERY_COUNTDOWN_TIMER,                    0x044E, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryCountdownTimer); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_QUERY_GUILD_MEMBERS_FOR_RECIPE,           0x0CFA, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryGuildMembersForRecipe); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_QUERY_GUILD_MEMBER_RECIPES,               0x04F0, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryGuildMemberRecipes); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_QUERY_GUILD_RECIPES,                      0x0478, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryGuildRecipes); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_QUERY_SCENARIO_POI,                       0x1A22, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleQueryScenarioPOI); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_QUEUED_MESSAGES_END,                      0x1093, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_REQUEST_CONQUEST_FORMULA_CONSTANTS,       0x0365, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestConquestFormulaConstants); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_REQUEST_INSPECT_RATED_BG_STATS,           0x0882, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleInspectRatedBGStatsOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_REQUEST_PET_INFO,                         0x135B, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleRequestPetInfoOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_REQUEST_RATED_BG_STATS,                   0x0826, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleRequestRatedBgStats); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_REQUEST_RESEARCH_HISTORY,                 0x15E2, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleArcheologyRequestHistory); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_REQUEST_VEHICLE_SWITCH_SEAT,              0x1143, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleChangeSeatsOnControlledVehicle);
	DEFINE_OPCODE_HANDLER(CMSG_RESET_CHALLENGE_MODE,                     0x1D61, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleResetChallengeMode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_ROLE_POLL_BEGIN,                          0x1882, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupInitiatePollRole); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_SAVE_GUILD_EMBLEM,                        0x1D60, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSaveGuildEmblemOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_SCENE_PLAYBACK_CANCELED,                  0x1087, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleScenePlaybackCanceled); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_SCENE_PLAYBACK_COMPLETE,                  0x0087, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleScenePlaybackComplete); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_SCENE_TRIGGER_EVENT,                      0x02C4, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSceneTriggerEvent); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_SELF_RES,                                 0x0360, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSelfResOpcode);
	...
	DEFINE_OPCODE_HANDLER(CMSG_SET_ACHIEVEMENTS_HIDDEN,                  0x0002, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_SET_ADVANCED_COMBAT_LOGGING,              0x0265, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetAdvancedCombatLogging); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_SET_EVERYONE_IS_ASSISTANT,                0x01E1, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleGroupEveryoneIsAssistantOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_SET_LFG_BONUS_FACTION_ID,                 0x0247, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetLfgBonusFactionId); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_SET_PET_SLOT,                             0x10A7, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleSetPetSlot);
	...
	DEFINE_OPCODE_HANDLER(CMSG_SET_RAID_DIFFICULTY,                      0x0591, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetRaidDifficultyOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_SET_SAVED_INSTANCE_EXTEND,                0x0C68, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleSetSavedInstanceExtend); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_SHOW_TRADE_SKILL,                         0x179F, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleShowTradeSkill); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_SUSPEND_TOKEN_RESPONSE,                   0x0292, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_TABARD_VENDOR_ACTIVATE,                   0x11C3, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTabardVendorActivateOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_TIME_SYNC_RESP,                           0x01DB, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleTimeSyncResp); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_TIME_SYNC_RESPONSE_DROPPED,               0x10D3, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_TUTORIAL_RESET,                           0x0307, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleTutorialReset); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_UNLEARN_SPECIALIZATION,                   0x1841, STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleUnlearnSpecializationOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_UPDATE_CLIENT_SETTINGS,                   0x1D8D, STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_UPGRADE_ITEM,                             0x1042, STATUS_LOGGEDIN,  PROCESS_INPLACE,      &WorldSession::HandleUpgradeItemOpcode); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(CMSG_USED_FOLLOW,                              0x0374, STATUS_UNHANDLED, PROCESS_INPLACE,      &WorldSession::Handle_NULL); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(CMSG_WARDEN_DATA,                              0x1816, STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleWardenDataOpcode); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_RUN_MODE,                         0x0979, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(MSG_MOVE_SET_WALK_MODE,                        0x08D1, STATUS_LOGGEDIN,  PROCESS_THREADSAFE,   &WorldSession::HandleMovementOpcodes); // 5.4.8 18414
...
#define DEFINE_OPCODE_HANDLER(opcode, opcodeNumber, status) ValidateAndSetOpcode<(opcodeNumber < NUM_OPCODE_HANDLERS), (opcode != 0)>(opcode, opcodeNumber, #opcode, status, PROCESS_INPLACE, 0);
	...
	DEFINE_OPCODE_HANDLER(SMSG_ACCOUNT_CRITERIA_UPDATE_ALL,               0x0A9E, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_ADD_LOSS_OF_CONTROL,                       0x0C13, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_ADD_RUNE_POWER,                            0x1860, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_AE_LOOT_TARGETS,                           0x0C32, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_AREA_TRIGGER_DENIED,                       0x148F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_AREA_TRIGGER_MOVEMENT_UPDATE,              0x0000, STATUS_UNHANDLED);
	DEFINE_OPCODE_HANDLER(SMSG_ARENA_ERROR,                               0x04BA, STATUS_UNHANDLED); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_ARENA_PREP_OPPONENT_SPECIALIZATIONS,       0x00BE, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_ARENA_UNIT_DESTROYED,                      0x000F, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_ATTACK_SWING_ERROR,                        0x11E1, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_AUCTION_LIST_PENDING_SALES,                0x0B81, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_ENTRY_INVITE,              0x1226, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_EXIT_REQUEST,              0x0000, STATUS_UNHANDLED);
	DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_QUEUE_INVITE,              0x142E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE,    0x08BE, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_CONFIRM_PURCHASE,               0x14E3, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_DELIVERY_ENDED,                 0x020B, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_DISTRIBUTION_LIST_RESPONSE, 0x043F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PRODUCT_LIST_RESPONSE,      0x1ABF, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_GET_PURCHASE_LIST_RESPONSE,     0x023A, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_PURCHASE_UPDATE,                0x14E2, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_DISTRIBUTION_ASSIGN_TO_TARGET_RESPONSE, 0x08AF, STATUS_UNHANDLED); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BATTLE_PAY_START_PURCHASE_RESPONSE,        0x0612, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_BLACK_MARKET_BID_ON_ITEM_RESULT,           0x148A, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BLACK_MARKET_OPEN_RESULT,                  0x00AE, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BLACK_MARKET_OUTBID,                       0x1040, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BLACK_MARKET_REQUEST_ITEMS_RESULT,         0x128B, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_BLACK_MARKET_WON,                          0x1060, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_CANCEL_COMBAT,                             0x0E8B, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_ALL_MAP_STATS,              0x11C2, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_COMPLETE,                   0x14E0, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_MAP_STATS_UPDATE,           0x083E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_NEW_PLAYER_RECORD,          0x10C3, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_REQUEST_LEADERS_RESULT,     0x182E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CHALLENGE_MODE_REWARDS,                    0x168A, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_CHARACTER_UPGRADE_COMPLETE,                0x083B, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_CHAR_FACTION_CHANGE_RESULT,                0x1D23, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_CLEAR_QUEST_COMPLETED_BIT,                 0x03EC, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CLEAR_QUEST_COMPLETED_BITS,                0x0364, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CLEAR_SPELL_CHARGES,                       0x00F2, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CLEAR_LOSS_OF_CONTROL,                     0x021F, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_CONNECT_TO,                                0x1149, STATUS_UNHANDLED); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_CROSSED_INEBRIATION_THRESHOLD,             0x1E9E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_CURRENCY_LOOT_RESTORED,                    0x0000, STATUS_UNHANDLED);
	DEFINE_OPCODE_HANDLER(SMSG_CUSTOM_LOAD_SCREEN,                        0x1CAF, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_DAMAGE_CALC_LOG,                           0x0000, STATUS_UNHANDLED);
	DEFINE_OPCODE_HANDLER(SMSG_DANCE_STUDIO_CREATE_RESULT,                0x1E9B, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_DESTRUCTIBLE_BUILDING_DAMAGE,              0x14BF, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_DISPEL_FAILED,                             0x085B, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_DISPLAY_GAME_ERROR,                        0x181F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_DISPLAY_PLAYER_CHOICE,                     0x1282, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_DISPLAY_PROMOTION,                         0x00A3, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_DISPLAY_TOAST,                             0x001B, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_FEATURE_SYSTEM_STATUS_GLUE_SCREEN,         0x121E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_FEIGN_DEATH_RESISTED,                      0x029E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_FISH_ESCAPED,                              0x0227, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_FISH_NOT_HOOKED,                           0x10BE, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GAMEOBJECT_PAGETEXT,                       0x14AF, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GAME_OBJECT_ACTIVATE_ANIM_KIT,             0x0C8A, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GROUP_UNINVITE,                            0x1313, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_ACHIEVEMENT_DATA,                    0x0EF8, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_ACHIEVEMENT_DELETED,                 0x1E61, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_CHALLENGE_COMPLETED,                 0x1AF8, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_CRITERIA_DELETED,                    0x1B60, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_BANK_TAB_DELETED,              0x0EF9, STATUS_UNHANDLED); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_DISBANDED,                     0x1E68, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_NEW_LEADER,                    0x0E69, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_PLAYER_JOINED,                 0x0B69, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_PLAYER_LEFT,                   0x0BF8, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_PRESENCE_CHANGE,               0x0B70, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_RANK_CHANGED,                  0x0EF0, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_EVENT_RANKS_UPDATED,                 0x1B69, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_FLAGGED_FOR_RENAME,                  0x0FE9, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_INVITE_DECLINED,                     0x1AF9, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_MAX_DAILY_XP,                        0x1BE1, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_MEMBERS_FOR_RECIPE,                  0x0BF0, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_MEMBER_DAILY_RESET,                  0x1BE8, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_MEMBER_RECIPES,                      0x0EE1, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_RECIPES,                             0x0FF1, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_GUILD_RENAMED,                             0x0E70, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_INITIAL_SETUP,                             0x0A8B, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_INSPECT_RATED_BG_STATS,                    0x041F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_INSPECT_RESULTS,                           0x1842, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_INSTANCE_LOCK_WARNING_QUERY,               0x00A7, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_INSTANCE_SAVE_CREATED,                     0x1EAE, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_ITEM_COOLDOWN,                             0x1904, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_ITEM_TEXT_QUERY_RESPONSE,                  0x1134, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_LFG_BOOT_PROPOSAL_UPDATE,                  0x183A, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_LFG_OFFER_CONTINUE,                        0x1EAB, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_PARTY_INFO,                            0x168E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_PLAYER_INFO,                           0x1861, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_PLAYER_REWARD,                         0x121A, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_PROPOSAL_UPDATE,                       0x1E3B, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_QUEUE_STATUS,                          0x1006, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_ROLE_CHECK_UPDATE,                     0x12BB, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_ROLE_CHOSEN,                           0x1A1F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_SLOT_INVALID,                          0x0C12, STATUS_UNHANDLED); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_TELEPORT_DENIED,                       0x063B, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_LFG_UPDATE_STATUS,                         0x0C2E, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_LF_GUILD_RECRUIT_LIST_UPDATED,             0x0E68, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_LOOT_ALL_PASSED,                           0x0EBB, STATUS_NEVER);
	...
	DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLL,                                 0x1840, STATUS_NEVER);
	DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLL_WON,                             0x0A3A, STATUS_NEVER);
	DEFINE_OPCODE_HANDLER(SMSG_LOOT_ROLLS_COMPLETE,                       0x101B, STATUS_NEVER);
	DEFINE_OPCODE_HANDLER(SMSG_LOOT_SLOT_CHANGED,                         0x0000, STATUS_UNHANDLED);
	DEFINE_OPCODE_HANDLER(SMSG_LOOT_START_ROLL,                           0x0EAA, STATUS_NEVER);
	DEFINE_OPCODE_HANDLER(SMSG_LOSS_OF_CONTROL_AURA_UPDATE,               0x049A, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_MAIL_LIST_RESULT,                          0x1C0B, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_MAIL_QUERY_NEXT_TIME_RESULT,               0x089B, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_MISSILE_CANCEL,                            0x1203, STATUS_NEVER);
	...
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_APPLY_MOVEMENT_FORCE,                 0x1DBE, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_REMOVE_MOVEMENT_FORCE,                0x0341, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_SET_CAN_TURN_WHILE_FALLING,           0x1065, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UNSET_CAN_TURN_WHILE_FALLING,         0x0D61, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_APPLY_MOVEMENT_FORCE,          0x0AB6, STATUS_UNHANDLED); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_COLLISION_HEIGHT,              0x1812, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_REMOVE_MOVEMENT_FORCE,         0x1464, STATUS_UNHANDLED); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_SWIM_BACK_SPEED,               0x025A, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_SWIM_SPEED,                    0x01E2, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_TELEPORT,                      0x15A9, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_TURN_RATE,                     0x0D62, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_MOVE_UPDATE_WALK_SPEED,                    0x0047, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_NEW_WORLD_ABORT,                           0x0C1B, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_NOTIFY_MISSILE_TRAJECTORY_COLLISION,       0x120A, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_OPEN_REFORGE,                              0x1E33, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_PAGE_TEXT_QUERY_RESPONSE,                  0x081E, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_INITIAL_UPDATE,                 0x0E1E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_FINALIZE_LOCATION,              0x082E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_FINAL_ROUND,                    0x1C2F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_FINISHED,                       0x04BB, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_FIRST_ROUND,                    0x0613, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_REQUEST_FAILED,                 0x022F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_PET_BATTLE_ROUND_RESULT,                   0x0C1A, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_PET_STABLE_LIST,                           0x1613, STATUS_NEVER);
	DEFINE_OPCODE_HANDLER(SMSG_PET_STABLE_RESULT,                         0x14BE, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_PET_TAME_FAILURE,                          0x040E, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_PET_UPDATE_COMBO_POINTS,                   0x1206, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_PLAYER_DIFFICULTY_CHANGE,                  0x128E, STATUS_UNHANDLED); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_PROC_RESIST,                               0x12BE, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_QUESTGIVER_QUEST_FAILED,                   0x12DE, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_ADD_CREDIT_SIMPLE,             0x07F5, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_FAILED,                        0x07DD, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_QUESTUPDATE_FAILEDTIMER,                   0x06FF, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_RAID_GROUP_ONLY,                           0x0D82, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_RAID_INSTANCE_INFO,                        0x16BF, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_RAID_INSTANCE_MESSAGE,                     0x0CAF, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_REALM_SPLIT,                               0x1A2E, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_REMOVE_LOSS_OF_CONTROL,                    0x1E13, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_RESUME_CAST_BAR,                           0x01D2, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_RESUME_COMMS,                              0x0969, STATUS_UNHANDLED); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_RESUME_TOKEN,                              0x188F, STATUS_UNHANDLED); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SAVE_GUILD_EMBLEM,                         0x089F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_SCENARIO_POIS,                             0x020A, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_SCENARIO_PROGRESS_UPDATE,                  0x02BA, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_SCENARIO_STATE,                            0x088F, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_SCRIPT_CAST,                               0x10C1, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SET_QUEST_COMPLETED_BIT,                   0x0354, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SHOW_MAILBOX,                              0x1F13, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SHOW_TRADE_SKILL_RESPONSE,                 0x00BA, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SPELLDISPELLOG,                            0x0DF9, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SPELLLOGMISS,                              0x1570, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SPELL_DAMAGE_SHIELD,                       0x05F3, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SPELL_OR_DAMAGE_IMMUNE,                    0x08FB, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_DISABLE,             0x186F, STATUS_UNHANDLED); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_SPLINE_MOVE_COLLISION_ENABLE,              0x006B, STATUS_UNHANDLED); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_START_ELAPSED_TIMER,                       0x0E1A, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_START_ELAPSED_TIMERS,                      0x00AB, STATUS_UNHANDLED); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_STOP_ELAPSED_TIMER,                        0x101E, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SUPERCEDED_SPELL,                          0x1943, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_SUSPEND_TOKEN,                             0x18BA, STATUS_UNHANDLED); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT,            0x0332, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_USERLIST_ADD,                              0x1462, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_USERLIST_REMOVE,                           0x0AAB, STATUS_NEVER); // 5.4.8 18414
	DEFINE_OPCODE_HANDLER(SMSG_USERLIST_UPDATE,                           0x063A, STATUS_NEVER); // 5.4.8 18414
	...
	DEFINE_OPCODE_HANDLER(SMSG_VIGNETTE_UPDATE,                           0x0CBE, STATUS_NEVER); // 5.4.8 18414
